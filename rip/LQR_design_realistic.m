...
% of physical meaning
tf1 = tf(sys);
tf_DT_bilinear = c2d(tf1,1/200,'zoh');
cl_tf = tf(sys_cl);
cl_tf_DT_bilinear = c2d(cl_tf,1/200,'zoh');
trial_index  = 4;
